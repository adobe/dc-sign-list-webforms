...
+ Download the latest release of the `dc-sign-list-webforms-<version>.jar` from the [Releases](https://git.corp.adobe.com/sign-acs/dc-sign-list-webforms/releases) page
